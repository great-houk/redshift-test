...
pub type CPU1_DBGEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DCFG_CC_SOCU_PIN_SPEC, CPU1_DBGEN_A, O>;
...
pub type FA_CMD_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DCFG_CC_SOCU_PIN_SPEC, FA_CMD_EN_A, O>;
...
pub type ME_CMD_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DCFG_CC_SOCU_PIN_SPEC, ME_CMD_EN_A, O>;
...
pub type CPU1_NIDEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DCFG_CC_SOCU_PIN_SPEC, CPU1_NIDEN_A, O>;
