...
pub type ENDEVPLUGINDET_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CTRL_CLR_SPEC, ENDEVPLUGINDET_A, O>;
...
pub type AUTORESUME_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_CLR_SPEC, bool, O>;
...
pub type ENAUTOSET_USBCLKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_CLR_SPEC, bool, O>;
...
pub type UTMI_SUSPENDM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_CLR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn utmi_suspendm(&mut self) -> UTMI_SUSPENDM_W<29> {
        UTMI_SUSPENDM_W::new(self)
    }
    #[doc = "Bit 30 - Gate UTMI Clocks"]
    #[inline(always)]
    #[must_use]
