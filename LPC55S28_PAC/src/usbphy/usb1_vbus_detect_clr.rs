...
pub type VBUS_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, VBUS_OVERRIDE_EN_A, O>;
...
pub type VBUSVALID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, VBUSVALID_SEL_A, O>;
...
pub type VBUS_SOURCE_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, u8, VBUS_SOURCE_SEL_A, 2, O>;
...
pub type ID_OVERRIDE_EN_R = crate::BitReader<bool>;
...
pub type ID_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, bool, O>;
#[doc = "Field `ID_OVERRIDE` reader - ID override value."]
pub type ID_OVERRIDE_R = crate::BitReader<bool>;
#[doc = "Field `ID_OVERRIDE` writer - ID override value."]
pub type ID_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, bool, O>;
#[doc = "Field `EXT_ID_OVERRIDE_EN` reader - Enable ID override using the pinmuxed value:"]
pub type EXT_ID_OVERRIDE_EN_R = crate::BitReader<EXT_ID_OVERRIDE_EN_A>;
...
pub type EXT_ID_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, EXT_ID_OVERRIDE_EN_A, O>;
impl<'a, const O: u8> EXT_ID_OVERRIDE_EN_W<'a, O> {
...
pub type EXT_VBUS_OVERRIDE_EN_R = crate::BitReader<EXT_VBUS_OVERRIDE_EN_A>;
...
pub type EXT_VBUS_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, EXT_VBUS_OVERRIDE_EN_A, O>;
impl<'a, const O: u8> EXT_VBUS_OVERRIDE_EN_W<'a, O> {
...
pub type VBUSVALID_TO_SESSVALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, VBUSVALID_TO_SESSVALID_A, O>;
...
pub type PWRUP_CMPS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, u8, PWRUP_CMPS_A, 3, O>;
...
pub type DISCHARGE_VBUS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, DISCHARGE_VBUS_A, O>;
...
between the VBUS_VALID comparator and the Session Valid comparator"]
    ...
    pub fn vbusvalid_5vdetect(&self) -> VBUSVALID_5VDETECT_R {
        VBUSVALID_5VDETECT_R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn pwrup_cmps(&self) -> PWRUP_CMPS_R {
        PWRUP_CMPS_R::new(((self.bits >> 20) & 7) as u8)
    }
...
is set to 1'b1"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn id_override_en(&mut self) -> ID_OVERRIDE_EN_W<11> {
        ID_OVERRIDE_EN_W::new(self)
    }
    #[doc = "Bit 12 - ID override value."]
    #[inline(always)]
    #[must_use]
    pub fn id_override(&mut self) -> ID_OVERRIDE_W<12> {
        ID_OVERRIDE_W::new(self)
    }
    #[doc = "Bit 13 - Enable ID override using the pinmuxed value:"]
    #[inline(always)]
    #[must_use]
    pub fn ext_id_override_en(&mut self) -> EXT_ID_OVERRIDE_EN_W<13> {
        EXT_ID_OVERRIDE_EN_W::new(self)
    }
    #[doc = "Bit 14 - Enable VBUS override using the pin muxed value."]
    #[inline(always)]
    #[must_use]
    pub fn ext_vbus_override_en(&mut self) -> EXT_VBUS_OVERRIDE_EN_W<14> {
        EXT_VBUS_OVERRIDE_EN_W::new(self)
    }
    #[doc = "Bit 18 - Selects the comparator used for VBUS_VALID This bit field controls the comparator used to report the VBUS_VALID results in USB1_VBUS_DETECT\\[3\\]
between the VBUS_VALID comparator and the Session Valid comparator"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn vbusvalid_5vdetect(&mut self) -> VBUSVALID_5VDETECT_W<19> {
        VBUSVALID_5VDETECT_W::new(self)
    }
    #[doc = "Bits 20:22 - Enables the VBUS_VALID comparator: Powers up the comparator used for the VBUS_VALID detector"]
    #[inline(always)]
    #[must_use]
