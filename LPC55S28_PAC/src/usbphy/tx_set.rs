...
pub type TXCAL45DM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_SET_SPEC, u8, u8, 4, O>;
...
pub type TXENCAL45DN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_SET_SPEC, bool, O>;
...
pub type TXENCAL45DP_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_SET_SPEC, bool, O>;
impl R {
