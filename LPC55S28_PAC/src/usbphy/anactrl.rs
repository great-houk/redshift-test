...
pub type LVI_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ANACTRL_SPEC, bool, O>;
...
pub type PFD_CLK_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ANACTRL_SPEC, u8, u8, 2, O>;
...
pub type DEV_PULLDOWN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ANACTRL_SPEC, DEV_PULLDOWN_A, O>;
