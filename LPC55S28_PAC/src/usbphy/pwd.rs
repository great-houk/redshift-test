...
pub type TXPWDFS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, TXPWDFS_A, O>;
...
pub type TXPWDIBIAS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, TXPWDIBIAS_A, O>;
...
pub type TXPWDV2I_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, TXPWDV2I_A, O>;
...
pub type RXPWDENV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, RXPWDENV_A, O>;
...
pub type RXPWD1PT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, RXPWD1PT1_A, O>;
...
pub type RXPWDDIFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, RXPWDDIFF_A, O>;
...
pub type RXPWDRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWD_SPEC, RXPWDRX_A, O>;
