...
pub type VBUS_SOURCE_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_VBUS_DETECT_SET_SPEC, u8, VBUS_SOURCE_SEL_A, 2, O>;
...
pub type EXT_ID_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_SET_SPEC, EXT_ID_OVERRIDE_EN_A, O>;
...
pub type EXT_VBUS_OVERRIDE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_SET_SPEC, EXT_VBUS_OVERRIDE_EN_A, O>;
...
pub type PWRUP_CMPS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_VBUS_DETECT_SET_SPEC, u8, PWRUP_CMPS_A, 3, O>;
