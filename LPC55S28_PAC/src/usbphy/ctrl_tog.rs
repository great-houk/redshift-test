...
pub type AUTORESUME_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_TOG_SPEC, bool, O>;
...
pub type ENAUTOSET_USBCLKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_TOG_SPEC, bool, O>;
...
pub type UTMI_SUSPENDM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_TOG_SPEC, bool, O>;
