...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIOCLKDIV_SPEC, RESET_AW, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SDIOCLKDIV_SPEC, HALT_A, O>;
