...
pub type CPU1SLEEPING_R = crate::BitReader<CPU1SLEEPING_A>;
...
pub type CPU1LOCKUP_R = crate::BitReader<CPU1LOCKUP_A>;
...
impl R {
    ...
    pub fn cpu1sleeping(&self) -> CPU1SLEEPING_R {
        CPU1SLEEPING_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    pub fn cpu1lockup(&self) -> CPU1LOCKUP_R {
        CPU1LOCKUP_R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
