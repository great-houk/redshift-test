...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSTICKCLKDIV1_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYSTICKCLKDIV1_SPEC, RESET_AW, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYSTICKCLKDIV1_SPEC, HALT_A, O>;
