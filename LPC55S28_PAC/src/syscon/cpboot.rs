...
pub type CPBOOT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CPBOOT` writer - Coprocessor Boot Address for CPU1."]
pub type CPBOOT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CPBOOT_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Coprocessor Boot Address for CPU1."]
    #[inline(always)]
    pub fn cpboot(&self) -> CPBOOT_R {
        CPBOOT_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Coprocessor Boot Address for CPU1."]
    #[inline(always)]
    #[must_use]
    pub fn cpboot(&mut self) -> CPBOOT_W<0> {
        CPBOOT_W::new(self)
    }
