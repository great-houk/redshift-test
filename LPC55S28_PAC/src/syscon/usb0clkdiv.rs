...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB0CLKDIV_SPEC, RESET_AW, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB0CLKDIV_SPEC, HALT_A, O>;
