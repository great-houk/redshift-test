...
pub type SRAM_CTRL3_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL_PRESETCTRL0_SPEC, SRAM_CTRL3_RST_A, O>;
...
pub type SRAM_CTRL4_RST_R = crate::BitReader<SRAM_CTRL4_RST_A>;
...
pub type SRAM_CTRL4_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL_PRESETCTRL0_SPEC, SRAM_CTRL4_RST_A, O>;
impl<'a, const O: u8> SRAM_CTRL4_RST_W<'a, O> {
    #[doc = "Bloc is not reset."]
    #[inline(always)]
    pub fn released(self) -> &'a mut W {
...
pub type GPIO2_RST_R = crate::BitReader<GPIO2_RST_A>;
...
pub type GPIO2_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL_PRESETCTRL0_SPEC, GPIO2_RST_A, O>;
impl<'a, const O: u8> GPIO2_RST_W<'a, O> {
    #[doc = "Bloc is not reset."]
    #[inline(always)]
    pub fn released(self) -> &'a mut W {
...
pub type GPIO3_RST_R = crate::BitReader<GPIO3_RST_A>;
...
pub type GPIO3_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL_PRESETCTRL0_SPEC, GPIO3_RST_A, O>;
impl<'a, const O: u8> GPIO3_RST_W<'a, O> {
    #[doc = "Bloc is not reset."]
    #[inline(always)]
    pub fn released(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sram_ctrl3_rst(&mut self) -> SRAM_CTRL3_RST_W<5> {
        SRAM_CTRL3_RST_W::new(self)
    }
    #[doc = "Bit 6 - SRAM Controller 4 reset control."]
    #[inline(always)]
    #[must_use]
    pub fn sram_ctrl4_rst(&mut self) -> SRAM_CTRL4_RST_W<6> {
        SRAM_CTRL4_RST_W::new(self)
    }
    #[doc = "Bit 7 - Flash controller reset control."]
    #[inline(always)]
    #[must_use]
