...
#[doc = "ENC_ENABLE (rw) register accessor: an alias for `Reg<ENC_ENABLE_SPEC>`"]
pub type ENC_ENABLE = crate::Reg<enc_enable::ENC_ENABLE_SPEC>;
#[doc = "Encryption Enable register"]
pub mod enc_enable;
#[doc = "MASK_LSB (w) register accessor: an alias for `Reg<MASK_LSB_SPEC>`"]
pub type MASK_LSB = crate::Reg<mask_lsb::MASK_LSB_SPEC>;
#[doc = "Data Mask register, 32 Least Significant Bits"]
pub mod mask_lsb;
#[doc = "MASK_MSB (w) register accessor: an alias for `Reg<MASK_MSB_SPEC>`"]
