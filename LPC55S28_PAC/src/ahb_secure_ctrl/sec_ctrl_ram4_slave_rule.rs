...
pub type RAM4_RULE_R = crate::FieldReader<u8, RAM4_RULE_A>;
...
pub type RAM4_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_RAM4_SLAVE_RULE_SPEC, u8, RAM4_RULE_A, 2, O>;
impl<'a, const O: u8> RAM4_RULE_W<'a, O> {
...
impl R {
    ...
    pub fn ram4_rule(&self) -> RAM4_RULE_R {
        RAM4_RULE_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Security access rules for the whole RAM4 : 0x2004_0000 - 0x2004_3FFF"]
    #[inline(always)]
    #[must_use]
    pub fn ram4_rule(&mut self) -> RAM4_RULE_W<0> {
        RAM4_RULE_W::new(self)
    }
