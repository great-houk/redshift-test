...
pub type USB_HS_DEV_RULE_R = crate::FieldReader<u8, USB_HS_DEV_RULE_A>;
...
pub type USB_HS_DEV_RULE_W<'a, const O: u8> = crate::FieldWriterSafe<
    'a,
    u32,
    SEC_CTRL_AHB_PORT9_SLAVE0_RULE_SPEC,
    u8,
    USB_HS_DEV_RULE_A,
    2,
    O,
>;
impl<'a, const O: u8> USB_HS_DEV_RULE_W<'a, O> {
...
pub type CRC_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_AHB_PORT9_SLAVE0_RULE_SPEC, u8, CRC_RULE_A, 2, O>;
...
impl R {
    ...
    pub fn usb_hs_dev_rule(&self) -> USB_HS_DEV_RULE_R {
        USB_HS_DEV_RULE_R::new(((self.bits >> 16) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_hs_dev_rule(&mut self) -> USB_HS_DEV_RULE_W<16> {
        USB_HS_DEV_RULE_W::new(self)
    }
    #[doc = "Bits 20:21 - CRC engine"]
    #[inline(always)]
    #[must_use]
