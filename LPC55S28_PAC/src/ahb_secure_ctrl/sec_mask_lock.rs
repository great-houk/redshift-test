...
pub type SEC_CPU1_INT_MASK0_LOCK_R = crate::FieldReader<u8, SEC_CPU1_INT_MASK0_LOCK_A>;
...
pub type SEC_CPU1_INT_MASK0_LOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SEC_MASK_LOCK_SPEC, u8, SEC_CPU1_INT_MASK0_LOCK_A, 2, O>;
impl<'a, const O: u8> SEC_CPU1_INT_MASK0_LOCK_W<'a, O> {
    #[doc = "Restricted mode."]
    #[inline(always)]
    pub fn blocked(self) -> &'a mut W {
...
pub type SEC_CPU1_INT_MASK1_LOCK_R = crate::FieldReader<u8, SEC_CPU1_INT_MASK1_LOCK_A>;
...
pub type SEC_CPU1_INT_MASK1_LOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SEC_MASK_LOCK_SPEC, u8, SEC_CPU1_INT_MASK1_LOCK_A, 2, O>;
impl<'a, const O: u8> SEC_CPU1_INT_MASK1_LOCK_W<'a, O> {
    #[doc = "Restricted mode."]
    #[inline(always)]
    pub fn blocked(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sec_cpu1_int_mask0_lock(&mut self) -> SEC_CPU1_INT_MASK0_LOCK_W<8> {
        SEC_CPU1_INT_MASK0_LOCK_W::new(self)
    }
    #[doc = "Bits 10:11 - SEC_CPU_INT_MASK1 register write-lock."]
    #[inline(always)]
    #[must_use]
    pub fn sec_cpu1_int_mask1_lock(&mut self) -> SEC_CPU1_INT_MASK1_LOCK_W<10> {
        SEC_CPU1_INT_MASK1_LOCK_W::new(self)
    }
...
impl crate::Resettable for SEC_MASK_LOCK_SPEC {
    const RESET_VALUE: Self::Ux = 0x0aaa;
}
