...
pub type SRAM_SECT_0_RULE_R = crate::FieldReader<u8, SRAM_SECT_0_RULE_A>;
...
pub type SRAM_SECT_0_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_USB_HS_MEM_RULE_SPEC, u8, SRAM_SECT_0_RULE_A, 2, O>;
impl<'a, const O: u8> SRAM_SECT_0_RULE_W<'a, O> {
...
pub type SRAM_SECT_1_RULE_R = crate::FieldReader<u8, SRAM_SECT_1_RULE_A>;
...
pub type SRAM_SECT_1_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_USB_HS_MEM_RULE_SPEC, u8, SRAM_SECT_1_RULE_A, 2, O>;
impl<'a, const O: u8> SRAM_SECT_1_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
...
pub type SRAM_SECT_2_RULE_R = crate::FieldReader<u8, SRAM_SECT_2_RULE_A>;
...
pub type SRAM_SECT_2_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_USB_HS_MEM_RULE_SPEC, u8, SRAM_SECT_2_RULE_A, 2, O>;
impl<'a, const O: u8> SRAM_SECT_2_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
...
pub type SRAM_SECT_3_RULE_R = crate::FieldReader<u8, SRAM_SECT_3_RULE_A>;
...
pub type SRAM_SECT_3_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_USB_HS_MEM_RULE_SPEC, u8, SRAM_SECT_3_RULE_A, 2, O>;
impl<'a, const O: u8> SRAM_SECT_3_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sram_sect_0_rule(&mut self) -> SRAM_SECT_0_RULE_W<0> {
        SRAM_SECT_0_RULE_W::new(self)
    }
    #[doc = "Bits 4:5 - Address space: 0x4010_1000 - 0x4010_1FFF"]
    #[inline(always)]
    #[must_use]
    pub fn sram_sect_1_rule(&mut self) -> SRAM_SECT_1_RULE_W<4> {
        SRAM_SECT_1_RULE_W::new(self)
    }
    #[doc = "Bits 8:9 - Address space: 0x4010_2000 - 0x4010_2FFF"]
    #[inline(always)]
    #[must_use]
    pub fn sram_sect_2_rule(&mut self) -> SRAM_SECT_2_RULE_W<8> {
        SRAM_SECT_2_RULE_W::new(self)
    }
    #[doc = "Bits 12:13 - Address space: 0x4010_3000 - 0x4010_3FFF"]
    #[inline(always)]
    #[must_use]
    pub fn sram_sect_3_rule(&mut self) -> SRAM_SECT_3_RULE_W<12> {
        SRAM_SECT_3_RULE_W::new(self)
    }
