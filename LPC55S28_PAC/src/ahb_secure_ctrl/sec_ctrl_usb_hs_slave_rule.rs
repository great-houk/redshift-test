...
pub type RAM_USB_HS_RULE_R = crate::FieldReader<u8, RAM_USB_HS_RULE_A>;
...
pub type RAM_USB_HS_RULE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SEC_CTRL_USB_HS_SLAVE_RULE_SPEC, u8, RAM_USB_HS_RULE_A, 2, O>;
impl<'a, const O: u8> RAM_USB_HS_RULE_W<'a, O> {
...
impl R {
    ...
    pub fn ram_usb_hs_rule(&self) -> RAM_USB_HS_RULE_R {
        RAM_USB_HS_RULE_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Security access rules for the whole USB High Speed RAM : 0x4010_0000 - 0x4010_3FFF"]
    #[inline(always)]
    #[must_use]
    pub fn ram_usb_hs_rule(&mut self) -> RAM_USB_HS_RULE_W<0> {
        RAM_USB_HS_RULE_W::new(self)
    }
