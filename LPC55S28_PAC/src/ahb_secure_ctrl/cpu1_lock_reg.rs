...
pub type LOCK_NS_VTOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CPU1_LOCK_REG_SPEC, u8, LOCK_NS_VTOR_A, 2, O>;
...
pub type LOCK_NS_MPU_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CPU1_LOCK_REG_SPEC, u8, LOCK_NS_MPU_A, 2, O>;
...
pub type CPU1_LOCK_REG_LOCK_R = crate::FieldReader<u8, CPU1_LOCK_REG_LOCK_A>;
...
pub type CPU1_LOCK_REG_LOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CPU1_LOCK_REG_SPEC, u8, CPU1_LOCK_REG_LOCK_A, 2, O>;
impl<'a, const O: u8> CPU1_LOCK_REG_LOCK_W<'a, O> {
    #[doc = "Restricted mode."]
    #[inline(always)]
    pub fn blocked(self) -> &'a mut W {
...
impl R {
    ...
    pub fn cpu1_lock_reg_lock(&self) -> CPU1_LOCK_REG_LOCK_R {
        CPU1_LOCK_REG_LOCK_R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - micro-Cortex M33 (CPU1) VTOR_NS register write-lock."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu1_lock_reg_lock(&mut self) -> CPU1_LOCK_REG_LOCK_W<30> {
        CPU1_LOCK_REG_LOCK_W::new(self)
    }
