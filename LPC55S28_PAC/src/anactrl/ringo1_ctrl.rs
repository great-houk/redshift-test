...
pub type S_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, S_A, O>;
...
pub type FS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, FS_A, O>;
...
pub type PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, PD_A, O>;
...
pub type E_R24_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_R24_A, O>;
...
pub type E_R35_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_R35_A, O>;
...
pub type E_M2_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_M2_A, O>;
...
pub type E_M3_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_M3_A, O>;
...
pub type E_M4_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_M4_A, O>;
...
pub type E_M5_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINGO1_CTRL_SPEC, E_M5_A, O>;
...
pub type DIVISOR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RINGO1_CTRL_SPEC, u8, u8, 4, O>;
